...
public class HouseEntity extends Entity{
    ...
    public final void setPoints()
    {
        ...
        /*if (chimney)
        {
            P.addPoint((int)(houseX+(houseW/1.5)), (int)(houseY-(houseH/2.2)));
            P.addPoint((int)(houseX+(houseW/1.5)), (int)(houseY-(houseH/2)));
            P.addPoint((int)(houseX+(houseW/1.3)), (int)(houseY-(houseH/2)));
        }*/
    ...
    public void onDraw(Graphics G, int viewX, int viewY) {
        if (X>viewX-houseW&&X<viewX+houseW+300&&Y>viewY-(houseH)&&Y<viewY+houseH+300)
        {
            if (chimney)
            {
                ...
                G.fillRect((int)(houseX+(houseW/1.5))-viewX, (int)(houseY-(houseH/2.2))-viewY,(int)(houseW*.2),houseH/2);
            }
            G.setColor(roof);
            ...
            G.drawLine(houseX+houseW-viewX, houseY-viewY, houseX+(houseW/2)-viewX, houseY-(viewY+(houseH/2)));
            G.setColor(wall);
    ...
    public static void reconstruct(ByteBuffer in, World world) {
        try {
            HouseEntity toAdd = new HouseEntity(in.getInt(),in.getInt(),in.getInt(),in.getInt()).setLook(new Color(in.getInt()), new Color(in.getInt()), new Color(in.getInt()), new Color(in.getInt()), in.getInt()==1?true:false);
