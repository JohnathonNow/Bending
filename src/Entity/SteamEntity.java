...
//                double xx = X+(bigness*scale)-r.nextInt((int)(bigness*2*scale))-viewX-(bigness*2*scale);
//                        double yy = Y+(bigness*scale)-r.nextInt((int)(bigness*2*scale))-viewY-(bigness*scale);
