...
import static destruct.ResourceLoader.loadIcon;
/*
 * Energy cost table:
 * <100 ~ Very Low
 * >100 ~ Low
        ...
        public void getAction(APPLET app) {
            ...
            X = app.world.x;
                        Y = app.world.y-World.head;
                                mx = app.world.viewX;
                                        my = app.world.mouseY-app.world.viewY;
                                        double direction = 360-APPLET.pointDir(app.world.x-app.world.viewX,app.world.y-app.world.viewY,app.world.mouseX,app.world.mouseY);
                    //direction+=180;
    ...
    public static class EarthbendingSpike extends Earthbending
    {
        ...
        public void getAction(APPLET app) {
            ...
            mx = app.world.mouseX+app.world.viewX;
                    ...
                    maker=ID;
                    if (!app.world.isSolid(X, Y)||app.pointDis(app.world.x, app.world.y, X, Y)>300||!app.world.inBounds(mx, my)||!app.world.inBounds(mx-56, my)||!app.world.inBounds(mx+56, my))
                                        {
                                            app.energico+=this.getCost();
                                            return;
                                        }
            ...
            X = app.world.x;
                        Y = app.world.y-World.head;
                                mx = (app.world.mouseX-app.world.viewX);
                                        my = (app.world.mouseY-app.world.viewY);
            app.xspeed=-Math.min(Math.max(((app.world.x-app.world.viewX)-app.world.mouseX),-16),16);
            app.world.vspeed=-Math.min(Math.max(((app.world.y-World.head-app.world.viewY)-app.world.mouseY),-16),16);
            my = (int)app.world.vspeed;
            app.world.keepMoving = false;
            mx = (int)app.xspeed;
           // my=-my;mx=-mx;
