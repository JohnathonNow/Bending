    ...
    public void paintComponent(Graphics G)
    {
        G.drawImage(APPLET.bimage, 0, 0,getWidth(),getHeight(), null);
          G.drawImage(stuff[4], 9+100, 60+12+200, this);
            ...
            G.drawImage(stuff[1], 12-((stuff[1].getWidth(this)-23)/2)+100, -(stuff[1].getHeight(this)-31)+12+200, this);
            ...
            jPanel1Layout.setHorizontalGroup(
                ...
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(160, 160, 160)
//                            .addComponent(canvas, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(65, 65, 65)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(buttonHead)
                                .addComponent(buttonBody)
                                .addComponent(buttonShoulder)
                                .addComponent(ForeArm)
                                .addComponent(ThighButton)
                                .addComponent(buttonShin))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(buttonHeadcolor)
                                .addComponent(buttonBodycolor)
                                .addComponent(buttonScolor)
                                .addComponent(buttonFcolor)
                                .addComponent(buttonTcolor)
                                .addComponent(buttonShincolor))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                           .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(buttonHeadcolor2)
                                .addComponent(buttonBodycolor2)
                                .addComponent(buttonScolor2)
                                .addComponent(buttonFcolor2)
                                .addComponent(buttonTcolor2)
                                .addComponent(buttonShincolor2))
                        )
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(103, 103, 103)
                ...
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(buttonFcolor).addComponent(buttonFcolor2)
                                .addComponent(ForeArm))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
//            );
   ...
   private void COLOR(int i, java.awt.event.ActionEvent evt) {                                                
        ...
        if (colors2[i]==null) colors2[i] = Color.BLACK;
        getImages();
    }   
    private void buttonHeadcolorActionPerformed(java.awt.event.ActionEvent evt) {                                                
        ...
        if (colors[1]==null) colors[1] = Color.BLACK;
        getImages();
    }                                               
    ...
    private void buttonBodycolorActionPerformed(java.awt.event.ActionEvent evt) {                                                
        ...
        if (colors[0]==null) colors[0] = Color.BLACK;
        getImages();
    }                                               
    ...
    private void buttonScolorActionPerformed(java.awt.event.ActionEvent evt) {                                             
        ...
        if (colors[2]==null) colors[2] = Color.BLACK;
        getImages();
    }                                            
    ...
    private void buttonFcolorActionPerformed(java.awt.event.ActionEvent evt) {                                             
        ...
        if (colors[3]==null) colors[3] = Color.BLACK;
        getImages();
    }                                            
    ...
    private void buttonTcolorActionPerformed(java.awt.event.ActionEvent evt) {                                             
        ...
        if (colors[4]==null) colors[4] = Color.BLACK;
        getImages();
    }                                            
    ...
    private void buttonShincolorActionPerformed(java.awt.event.ActionEvent evt) {                                                
        ...
        if (colors[5]==null) colors[5] = Color.BLACK;
        getImages();
    }                                               
