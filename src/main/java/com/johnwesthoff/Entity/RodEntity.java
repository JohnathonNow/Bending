...
import static com.johnwesthoff.Entity.Entity.r;
...
import com.johnwesthoff.Destruct.APPLET;
...
public class RodEntity extends Entity {
    ...
    public void onDraw(Graphics G, int viewX, int viewY) {
        if (X > viewX && X < viewX + 300 && Y > viewY && Y < viewY + 300) {
            ...
            int xx = (int) X + (int) APPLET.lengthdir_x(dis, dir) - viewX,
                    yy = (int) Y + (int) APPLET.lengthdir_y(dis, dir) - 34 - viewY;
            dir = r.nextInt(360);
            dis = 8 + r.nextInt(16);
